...
public class SampleSocketClientPart51 {
	Socket server;
	...
	private void processPayload(PayloadPart5 payload) {
		...
		case CONNECT:
			System.out.println(
					String.format("Client2 \"%s\" connected", payload.getMessage())
			);
			break;
		case DISCONNECT:
			System.out.println(
					String.format("Client2 \"%s\" disconnected", payload.getMessage())
			);
			break;
		case MESSAGE:
			System.out.println(
	...
	public static void main(String[] args) {
		SampleSocketClientPart51 client = new SampleSocketClientPart51();
